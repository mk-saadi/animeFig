		...
		<div>
			...
			>
				<div className="flex justify-between gap-x-4">
					...
					{/* info component */}
					<div
						className={`sticky top-[5%] pr-8 pl-4 h-full w-full min-h-screen overflow-auto duration-500
												...
												className={`flex relative items-center p-3 cursor-pointer rounded-md justify-start w-full ${
													{
														...
														"Pre Owned":
															"bg-yellow-500 hover:scale-105 duration-300",
														"Brand New":
															"bg-green-500 hover:scale-105 duration-300",
														"Re-Release":
															"bg-purple-500 hover:scale-105 duration-300",
														"Out Of Stock":
